<template>
    <div class="flex flex-col relative justify-center align-center items-center w-full">
        <svg :fill="color" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"
            class="icon icon-tabler icons-tabler-filled icon-tabler-binoculars transition-all duration-300 ease-in-out">
